...
{
    internal partial class UnknownFineTuningJobRequestMethod : IJsonModel<FineTuningTrainingMethod>
    {
        internal UnknownFineTuningJobRequestMethod()
        {
        }
        ...
        internal static UnknownFineTuningJobRequestMethod DeserializeUnknownFineTuningJobRequestMethod(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownFineTuningJobRequestMethod(@type, additionalBinaryDataProperties);
        }
