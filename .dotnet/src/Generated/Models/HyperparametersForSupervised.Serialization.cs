...
namespace OpenAI.FineTuning
{
    public partial class HyperparametersForSupervised : IJsonModel<HyperparametersForSupervised>
    {
        ...
        protected virtual HyperparametersForSupervised JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HyperparametersForSupervised)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeHyperparametersForSupervised(document.RootElement, options);
        }

        internal static HyperparametersForSupervised DeserializeHyperparametersForSupervised(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new HyperparametersForSupervised(batchSize, nEpochs, learningRateMultiplier, additionalBinaryDataProperties);
        }
        ...
        {
            if (hyperparametersForSupervised == null)
            {
                return null;
            }
            return BinaryContent.Create(hyperparametersForSupervised, ModelSerializationExtensions.WireOptions);
        }
        ...
        public static explicit operator HyperparametersForSupervised(ClientResult result)
        {
            ...
            return DeserializeHyperparametersForSupervised(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
