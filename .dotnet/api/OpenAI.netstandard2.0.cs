...
namespace OpenAI.FineTuning {
    ...
    public class FineTuningJobError : IJsonModel<FineTuningJobError>, IPersistableModel<FineTuningJobError> {
        ...
        string IPersistableModel<FineTuningJobError>.GetFormatFromOptions(ModelReaderWriterOptions options);
